      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="flex items-center gap-3">
            {loading ? (
              <div className="h-9 w-[170px] bg-interactive-bg backdrop-blur-md rounded-md animate-pulse" />
            ) : (
              repoData && (
                <motion.button
                  onClick={handleGitHubClick}
                  className="relative flex overflow-hidden items-center gap-2 h-9 px-4 py-2 bg-black text-white dark:bg-white dark:text-black rounded-md shadow-sm transition-all duration-300 ease-out group cursor-pointer"
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
