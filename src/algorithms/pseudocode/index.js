...
/**
 * Static pseudocode strings per algorithm key (same keys as JS/Python registry).
 * Style: uppercase keywords, plain English, arrow assignment (←), indentation.
 */
...
export function getPseudocode(algorithmKey) {
  return pseudocodeByAlgorithm[algorithmKey] ?? null;
}
